          ...
          <div key={apiKey.id} className="bg-white border border-gray-200 rounded-lg p-4">
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <p className="text-xs text-gray-500">{apiKey.type}</p>
              </div>
              <div className="flex items-center space-x-2">
                <button
                  onClick={() => toggleViewKey(apiKey.id)}
            ...
            <div className="space-y-2">
              <div>
                ...
                <span className="text-xs text-gray-900 ml-1">{apiKey.usage}</span>
              </div>
              <div>
                <span className="text-xs text-gray-500">Key:</span>
                <div className="text-xs text-gray-900 font-mono mt-1 break-all">
                  {viewingKey === apiKey.id ? apiKey.key : maskApiKey(apiKey.key)}
                </div>
              </div>
            </div>
